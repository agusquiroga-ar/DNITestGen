...
| **7** | **Generated Codes Directory** | [07_generated_codes_directory.md](file:///c:/dev/DNITestGen/docs/features/07_generated_codes_directory.md) | Feature 6 | Medium |
...
6. **Feature 7** adds session management and a visual history of the generated codes. It depends on Feature 6 being completed so there are actual codes to serialize, save, and render dynamically from history.
